...
<head>
    ...
    <title>Lupa Email - JBmotorBekas</title>
    ...
    <div class="hero-section hidden lg:flex items-center justify-center relative">
        <div class="max-w-lg text-center relative z-10 px-8">
            ...
            <p class="text-red-200 text-lg mb-8 leading-relaxed">
                Masukkan nama lengkap Anda dan kami akan mengirimkan email terdaftar ke alamat email Anda
            </p>
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <div class="flex items-center justify-center gap-3 text-white/90">
                    ...
                    <span class="font-semibold">Pengingat Email</span>
                </div>
                <p class="text-white/80 text-sm mt-2">Kami akan mencari berdasarkan nama yang Anda daftarkan</p>
            </div>
        </div>
    </div>

    <!-- RIGHT SIDE - FORGOT EMAIL FORM -->
        ...
        <div class="w-full max-w-md">
            <div class="forgot-card rounded-2xl p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">Cari Email Terdaftar</h2>
                    <p class="text-gray-600">Masukkan nama lengkap yang Anda gunakan saat registrasi</p>
                </div>
                ...
                <!-- Forgot Email Form -->
                <form method="POST" action="{{ route('forgot.email.send') }}" class="space-y-6">
                    @csrf
                ...
                <div class="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="font-semibold text-blue-900 mb-1">Cara Kerja</h4>
                            <ul class="text-sm text-blue-800 space-y-1">
                                <li>• Masukkan nama lengkap yang Anda gunakan saat registrasi</li>
                                <li>• Kami akan mencari email yang terdaftar dengan nama tersebut</li>
                                <li>• Email pengingat akan dikirim ke alamat email yang ditemukan</li>
                                <li>• Pastikan nama yang dimasukkan sesuai dengan data registrasi</li>
                            </ul>
                        </div>
                    </div>
                </div>
